...
contract NekoChainGames is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xdC4e7B2C57FD5F6c3086e4E0ff93698452B872C2); 
    ...
    function changeRouterVersion(address _router) public onlyOwner returns(address _pair) {
        ...
        // contract variables of the router
        uniswapV2Router = _uniswapV2Router;
    }
